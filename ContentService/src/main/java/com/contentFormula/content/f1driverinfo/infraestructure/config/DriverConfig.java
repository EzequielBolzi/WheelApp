package com.contentFormula.content.f1driverinfo.infraestructure.config;

import com.contentFormula.content.f1driverinfo.application.service.DriverInfoService;
import com.contentFormula.content.f1driverinfo.application.usecases.DriverInfoUseCaseImpl;
