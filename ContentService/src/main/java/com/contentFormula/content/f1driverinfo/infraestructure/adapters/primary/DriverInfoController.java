package com.contentFormula.content.f1driverinfo.infraestructure.adapters.primary;
...
import com.contentFormula.content.f1driverinfo.infraestructure.adapters.secondary.DriverInfoAdapter;
...
@RestController
@RequestMapping("/api/v1/f1_driver")
