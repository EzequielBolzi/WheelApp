...
import com.contentFormula.content.f1driverRaceresult.infraestructure.entities.DriverRaceResultEntity;
...
public class DriverRaceResultMapper {
    ...
    private static DriverInfo driverInfoToDomain(com.contentFormula.content.f1driverinfo.infraestructure.entities.DriverInfoEntity entity) {
        if (entity == null) return null;
        return DriverInfoMapper.toDomain(entity);
    }

    private static com.contentFormula.content.f1driverinfo.infraestructure.entities.DriverInfoEntity driverInfoToEntity(DriverInfo domain) {
        if (domain == null) return null;
